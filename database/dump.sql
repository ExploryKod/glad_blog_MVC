...
(1,	'Pour démarrer un blog MVC en local, Docker Compose suffit : un service PHP/Apache, une base MariaDB et éventuellement Adminer. Les points essentiels sont build (Dockerfile), volumes (code monté dans le conteneur), ports (1300:80) et environment (identifiants MySQL). Une fois les conteneurs démarrés, composer install s’exécute au boot pour générer vendor/.',	16,	'Docker Compose en pratique',	1,	'https://images.pexels.com/photos/12704642/pexels-photo-12704642.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',	'amaury',	'2026-07-19'),
(2,	'L’architecture MVC sépare clairement les responsabilités : les Controllers orchestrent la requête, les Entities portent les règles métier, les Managers gèrent la persistance SQL. Le Front Controller (index.php) route via des attributs #[Route] et injecte les dépendances grâce à AppContainer. Objectif : des contrôleurs fins et un domaine riche, sans framework.',	16,	'Architecture MVC sans framework',	1,	'https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',	'amaury',	'2026-07-19');
