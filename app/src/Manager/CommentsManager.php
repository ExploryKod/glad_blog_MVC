...
class CommentsManager extends BaseManager
{
    ...
    {
        $query = $this->pdo->prepare("INSERT INTO comments (author_comment, content_comment, id_post, post_title, admin_comment)
                                                VALUES (:author_comment, :content_comment, :id_post, :post_title, :admin_comment) LIMIT 1");
        $query->execute([
