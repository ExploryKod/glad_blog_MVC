...
class Route
{
    ...
    {
        // $match est passé par référence (créer une allocation mémoire donc on cherche le num de l'endroit où ça pointe et non le contenu)
        // et ça revient à faire $match = preg_match("#{$this->path}#", $url) pour l'utiliser ensuite.
